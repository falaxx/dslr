...
import os.path
from os import path
from utils import std_,mean_,exit_
...
if __name__ == '__main__':
	try:
		...
		data = data.fillna(0)
		data2 = pd.read_csv(fileweight)
		if path.exists(fileweight) == False or os.stat(fileweight).st_size == 0 and is_non_zero_file(fileweight):
			print("weight file doesn't exist or is empty") 
			exit_()
